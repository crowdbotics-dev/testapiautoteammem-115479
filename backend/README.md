...
## Project Structure
    ...
    ├── testapiautoteammem_115479  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_115479`
...
2. Clone this repo and `cd testapiautoteammem_115479`
